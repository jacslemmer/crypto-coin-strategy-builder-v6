import { fetchTradingViewChart, createDefaultConfig } from './src/tradingview-chart-fetcher.js';

// Simple test to verify the JavaScript version works
const testFunction = async () => {
  console.log('🧪 Testing TradingView Chart Fetcher (JavaScript Version)...');
